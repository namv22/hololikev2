<template>
  <div class="wrapper">
    <parallax class="page-header header-filter" :style="headerStyle">
      <iframe src="https://www.youtube.com/embed/O-SXhtYjprc?playlist=O-SXhtYjprc&autoplay=1&loop=1&mute=1&controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="height:100%;width:100%;border:none;overflow:hidden;"></iframe>
      <!-- <div id="over" class="md-layout">
...
<br/><br/>
  ...
  <button @click="onClick($event)">
    <span id="background" :style="{ backgroundImage: `url(${SoraBG})` }"></span>
    <span id="shade"></span>
...
export default {
  ...
  data() {
    return {
      ...
      // },
      Soratxt: "Tokino Sora",
    SoraBG: "https://static.miraheze.org/hololivewiki/0/0f/Tokino_Sora_-_Portrait_06-1.png"
    };
  },
  methods: {
    // search(searchParams) {
