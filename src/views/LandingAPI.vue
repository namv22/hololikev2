...
<div class="wrapper">
    <div class="main main-raised">
                        ...
                        <b-card>
                            ...
                            <b-list-group>
                                <b-list-group-item button>
                                    <b-img v-bind="mainProps" rounded src="https://picsum.photos/500/500/?image=54" alt="Rounded image"></b-img>
                                    Button item
                                </b-list-group-item>
                            ...
                            <div class="team-player">
                                <md-card class="md-card-plain">
                                    <div class="md-layout-item mx-auto">
                                        ...
                                        <img alt="Rounded Image" class="rounded" :class="{ 'responsive-image': responsive }" :src="video.snippet.thumbnails.high.url" />
                                    </div>
                                    <md-card-content>
                                        <h4>
                                            {{ video.snippet.title }}
                                    ...
                                    <md-card-actions class="text-center">
                                        <b-button v-b-modal.modal-xl="'game'" @click="sendInfo(post)" variant="outline-secondary">Xem
                                        </b-button>
                                    </md-card-actions>
                                </md-card>
                            </div>
        ...
        <b-modal size="xl" id="game" :title="selectedPost.name">
            <b-embed type="iframe" aspect="16by9" :src="'https://www.youtube.com/embed/' + video.id.videoId allowfullscreen></b-embed>
        </b-modal>
    </div>
</div>
</template>
